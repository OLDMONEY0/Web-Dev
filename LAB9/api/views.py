...
def get_companies(request):
    ...
    if request.method == "POST":
        ...
        company = Company.objects.create(name=comp_name, city=comp_city, description=comp_description,
...
def get_vacancies(request):
    ...
    if request.method == "POST":
        ...
        vacancy = Vacancy.objects.create(name=vac_name, salary=vac_salary, description=vac_description,
                                         company=company_obj)
